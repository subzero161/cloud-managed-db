...
db_gcp = pd.read_sql_query("SELECT * FROM patients", db_gcp)
...
df_gcp = pd.read_sql_query("SELECT * FROM patients")
...
#icd10codesShort_1k_mod.to_sql('conditions', con=db_gcp, if_exists='replace', index=False)
